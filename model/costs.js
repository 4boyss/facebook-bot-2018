...
const list = (payload = {} , field = {} , exist = {}) => {
  const { limit = 10, skip =0, ascending, descending = 'createdAt', greaterThan, lessThan} = payload
...
const updateById = (id, payload = {}) => {
  ...
  return query.get(id).then(function (_obj) {
...
module.exports = {create, remove, list, updateById}
